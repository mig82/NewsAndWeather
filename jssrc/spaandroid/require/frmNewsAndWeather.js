define("frmNewsAndWeather", function() {
    return function(controller) {
        function addWidgetsfrmNewsAndWeather() {
            ...
            var flxWeatherCard = new kony.ui.FlexContainer({
                "autogrowMode": kony.flex.AUTOGROW_NONE,
                "clipBounds": true,
                "height": "51%",
                "id": "flxWeatherCard",
            ...
            flxWeatherCard.setDefaultUnit(kony.flex.DP);
            ...
            socialSharing.MimeType = "PDF";
            socialSharing.Subject = "Travel Itinerary";
            socialSharing.FileName = "TravelItinerary";
            flxWeatherCard.add(flexTodayWeather, flexWeather, socialSharing);
            ...
            flexScrollNewsAndWeather.add(flxWeatherCard, lblStrip, segNews);
