define({
    ...
    getSelectedCategory: function(id) {
        ...
        var category;
        if (id == 10) {
            this.view.flxWeatherCard.isVisible = true;
            this.view.lblStrip.isVisible = true;
        } else {
            this.view.flxWeatherCard.isVisible = false;
    ...
    setShareContent: function() {
        kony.image.createImageFromSnapShot(this.view.flxWeatherCard);
        var imageToSHare = kony.image.createImageFromSnapShot(this.view.flxWeatherCard);
        var imgRawBytesToSHare = imageToSHare.getImageAsRawBytes();
        var imgBase64 = kony.convertToBase64(imgRawBytesToSHare);
        this.view.socialSharing.setContent(imgBase64);
    }
});