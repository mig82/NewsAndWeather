...
kony.sdk.OnlineObjectService = function(konyRef, serviceName) {
    ...
    this.getBinaryData = function(options, fileDownloadStartedCallback, chunkDownloadCompletedCallback, fileDownloadCompletedCallback, downloadFailureCallback) {
        ...
        function getBinaryDataOperationHandler() {
            currentObject.getMetadataOfObject(objName, {}, function(response) {
                _getBinaryData(options, tmpDataUrl, true, streamingFlag, fileDownloadStartedCallback, chunkDownloadCompletedCallback, fileDownloadCompletedCallback, downloadFailureCallback);
            }, function(error) {
    ...
    this.getBinaryData = function(options, binaryAttributeName, fileDownloadStartedCallback, chunkDownloadCompletedCallback, fileDownloadCompletedCallback, downloadFailureCallback) {
        if (kony.sdk.isNullOrUndefined(options)) {
            kony.sdk.verifyAndCallClosure(downloadFailureCallback, kony.sdk.error.getClientErrObj(kony.sdk.errorcodes.null_or_undefined, "options" + kony.sdk.errormessages.null_or_undefined));
            return;
        }
        ...
        if (kony.sdk.isNullOrUndefined(binaryAttributeName)) {
        ...
        function getBinaryDataOperationHandler() {
            currentObject.getMetadataOfObject(objName, {}, function(response) {
                _getBinaryData(options, tmpDataUrl, false, streamingFlag, fileDownloadStartedCallback, chunkDownloadCompletedCallback, fileDownloadCompletedCallback, downloadFailureCallback);
            }, function(error) {
                kony.sdk.logsdk.error("### OnlineObjectService::getBinaryData Error:", error);
                kony.sdk.verifyAndCallClosure(downloadFailureCallback, error);
                return;
    ...
    function _getBinaryData(options, tmpDataUrl, externalSource, streamingFlag, fileDownloadStartedCallback, chunkDownloadCompletedCallback, fileDownloadCompletedCallback, downloadFailureCallback) {
        ...
        function invokeSuccessCallback(downloadConfig) {
            ...
            if (typeof(binarydata) !== "undefined") {
                ...
                binarydata.getOnlineBinaryData(dataObject.getRecord(), streamingFlag, downloadConfig, fileDownloadStartedCallback, chunkDownloadCompletedCallback, fileDownloadCompletedCallback, downloadFailureCallback);
            } else {
        ...
        if (externalSource) {
            if (kony.sdk.isNullOrUndefined(dataObject.getRecord())) {
                kony.sdk.logsdk.error("### OnlineObjectService::_getBinaryData Error: Please provide file params to get Binary content.");
                kony.sdk.verifyAndCallClosure(downloadFailureCallback, kony.sdk.error.getClientErrObj(kony.sdk.errorcodes.primarykey_unavailable, kony.sdk.errormessages.primarykey_unavailable));
                return;
            }
            invokeObjectOperation(url, dataObject.getObjectName(), headers, null, kony.sdk.constants.HTTP_METHOD_GET, invokeSuccessCallback, invokeFailureCallback, networkProviderOptions);
            ...
            if (typeof(binarydata) !== "undefined") {
                ...
                binarydata.getOnlineBinaryData({
                    "fileId": dataObject.getRecord()[pkey]
                }, streamingFlag, {
                    "endpointUrl": url,
                    "headers": {
                        "X-Kony-Authorization": kony.sdk.getCurrentInstance().currentClaimToken,
                        "X-Kony-API-Version": headers["X-Kony-API-Version"]
                    }
                }, fileDownloadStartedCallback, chunkDownloadCompletedCallback, fileDownloadCompletedCallback, downloadFailureCallback);
            } else {
                kony.sdk.verifyAndCallClosure(downloadFailureCallback, "FFI is not configured to use Binary Apis");
            }
        }
...
kony.logger = {
    appLoggerInitialisation: function() {
        ...
        this.currentLogLevel = this.logLevel.ERROR;
        return loggerObj;
    },
